...
노린 건 여기까지였습니다. **나란히 달리기가 그냥 잘 두는 것보다 낮아졌습니다.** 위험을 안 지는 전략이 최적해 자리에서 내려왔어요.

다만 정직하게 덧붙이면, **틈 사냥이 압도적으로 유리하지는 않습니다.** 평균이나 상위 10%로 보면 먹이만 착실히 쫓는 쪽과 비슷해요. 차이는 **분포**에 있습니다. 6,671 같은 판은 틈 사냥에서만 나오지만, 대신 열에 한 번은 대가를 치릅니다.

그러니까 좁은 틈을 노리는 건 **기댓값을 올리는 선택이 아니라 판을 크게 벌리는 선택**입니다. 하루 한 판으로 겨루는 게임이라 저는 이 정도가 맞다고 봤습니다. 안전하게 굴리면 고만고만한 점수가 나오고, 크게 가려면 죽을 자리에 들어가야 하니까요.
